...
integer, parameter :: n_horiz = 3, n_vert = 3, N = 10**5                !!numero celle orizzontali e verticali, numero di campionamenti
...
print *, ''
print *, 'beta=', beta
print *, 'acceptance=', acceptance/(N*(columns-2)*(rows-2))
print *, ''
...
function totalE(lattice, rows, columns, norm) result(E) !!definita a meno di un fattore norm/rows*columns a moltiplicare E in uscita
implicit none
double precision :: E
